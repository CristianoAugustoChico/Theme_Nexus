...
if ( $current_slug == 'cat_pesquisadores/videos' ): // se a taxonomia for Vídeos
		get_template_part ( 'template-parts/pesquisadores/category', 'videos' );

	elseif ( $current_slug == 'cat_pesquisadores/outros'): // thems list padrão
		get_template_part ( 'template-parts/pesquisadores/category', 'outros' );

	else: // lista todos o conteúdo da Custom Post
		// Chama o arquivo front-end.php para exibição do conteúdo geral inicial da seção
		get_template_part ( 'template-parts/pesquisadores/front', 'end' );
endif;
