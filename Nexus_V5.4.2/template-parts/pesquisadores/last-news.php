...
<div class="row">
	<?php // Exibe uma página inicial para a custom post pesquisadores
		$args = array( 'post_type' => 'pesquisadores', 'cat_pesquisadores' => 'outros', 'posts_per_page' => 4  );
	...
	<div class="col md-126">
		<!-- Leia mais -->
			<div id="leia-mais" class="col-md-12">
				<a href="/nexus/cat_pesquisadores/outros/"></a>
			</div>
	</div>
</div>