...
<div class="row">
	...
	<div class="col-md-8 col-md-offset-1">
		<?php get_template_part ( 'template-parts/estudantes/section', 'text' ); ?>
	</div>
</div>
...
<div id="border-seccao">
	<div class="row">
		<!-- bloco de vídeos -->
		<div class="col-md-4">
			<?php get_template_part ('template-parts/estudantes/last', 'video'); ?>
		</div>

		<!-- bloco de artigos -->
		<div class="col-md-7 col-md-offset-1">
			<?php get_template_part ( 'template-parts/estudantes/last', 'publicacao' ); ?>
		</div>
	</div>
</div>
...
<div id="border-seccao">
	<?php get_template_part ( 'template-parts/estudantes/last', 'news' ); ?>
</div>