...
if ( $current_slug == 'cat_estudantes/videos' ): // se a taxonomia for Vídeos
		get_template_part ( 'template-parts/estudantes/category', 'videos' );

	elseif ( $current_slug == 'cat_estudantes/outros'): // thems list padrão
		get_template_part ( 'template-parts/estudantes/category', 'outros' );

	else: // lista todos o conteúdo da Custom Post
		// Chama o arquivo front-end.php para exibição do conteúdo geral inicial da seção
		get_template_part ( 'template-parts/estudantes/front', 'end' );
endif;
?>